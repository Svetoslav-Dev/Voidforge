...
- Add the ability to download personal info. For example all receipts. Ability to delete profile from front end.
- Add an smpt or mail provider when placing an order to send emails
- Fix page /cart text to look nicer for Continue shopping
- Add which packages should be installed via npm and how to build this app locally for yourself
- For page /admin/products move buttons add shirt and back to dashboard & remove back to dashboard to something better
- Change the color of the buttons a little bit
...
- Add some kind of throtle
- Add some kind of middleware
- check if status codes returned are correct
- check other payment methods maybe save the data locally
