...
@section('content')
    ...
    <section class="card legal-card">
        <h2 style="color: #4ecba3;">Return requests</h2>
        ...
        <h2 style="color: #4ecba3;">Refund handling</h2>
        ...
        <h2 style="color: #4ecba3;">Withdrawal rights</h2>
        ...
        <h2 style="color: #4ecba3;">Condition of returned goods</h2>
        ...
        <h2 style="color: #4ecba3;">Store note</h2>
