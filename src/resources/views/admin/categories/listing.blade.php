...
@section('content')
    ...
    <div data-admin-list-search-page>
        <section class="card hero">
            <div>
                <h1 style="color: #d89a58;">Manage the storefront categories</h1>
            ...
            <div class="admin-toolbar">
                ...
                <form method="GET" action="{{ route('admin.categories.index') }}" class="inline-form admin-toolbar-right admin-search" data-admin-list-search-form>
